      ...
      <div className="flex flex-col md:flex-row items-center md:justify-center">
        <div className="md:w-1/2 flex flex-col items-start gap-12">
          ...
          <div className='text-left font-semibold'>
            ...
            <div className=' w-[95px] h-4 bg-pink-500 rounded-sm -mt-[140px] -mr-2 z-0'></div>
          </div>
        ...
        <div className="absolute top-[-20px] left-[170px] w-96 h-96 bg-pink-600 rounded-[32px] z-0"></div>
          <img
